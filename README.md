...
<h2>🛠 Dependencies</h2>
<ul>
  <li>clang (with -m32 and as support)</li>
  <li>lld</li>
  <li>gmake</li>
  <li>grub-mkrescue</li>
  <li>xorriso</li>
...
<pre><code>just need type make run</code></pre>
...
<ul>
  ...
  <li>Fork improvements:
    <ul>
      ...
      <li>Removed broken components like clock, date, and datetime commands.</li>
    </ul>
  </li>
</ul>
...
<table>
  ...
  <tbody>
    ...
    <tr><td>Tools: own linker, C compiler, C library, or LLVM/binutils/GCC</td><td>⛔️ Not done</td></tr>
